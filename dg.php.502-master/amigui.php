...
$csv = array_map('str_getcsv', file('https://raw.githubusercontent.com/nicoconfused/clase_15_mayo/gh-pages/datos.csv'));
...
for($a = 0; $a < $total = count($csv); $a++){?>
  <article class="row">
    <hr>
    <div class="col-xs-5 col-sm-3 col-md-2"><img src="<?php echo $csv[$a]['titulo'];?>" class="img-responsive"></div>
    <div class="col-xs-7 col-sm-9 col-md-10">
      <h3><?php echo($a+1);?>. <?php echo $csv[$a]['titulo'];?></h3>
        <h5>Dirigida por <?php echo $csv[$a]['texto'];?> </h5>
        <h5>Dirigida por <?php echo $csv[$a]['apa'];?> </h5>
          <h5>Dirigida por <?php echo $csv[$a]['vinculo'];?> </h5>
            <h5>Dirigida por <?php echo $csv[$a]['tags'];?> </h5>
